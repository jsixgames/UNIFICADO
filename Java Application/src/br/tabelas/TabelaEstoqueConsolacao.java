...
public class TabelaEstoqueConsolacao extends AbstractTableModel {   
    ...
    private List<EstoqueConsolacao> valores;         
  
    //Esse é um construtor, que recebe a nossa lista de livros   
    public TabelaEstoqueConsolacao(List<EstoqueConsolacao> valores) {
    ...
    public Object getValueAt(int row, int column) {   
        ...
        EstoqueConsolacao titulo = valores.get(row);   
        if (column == COD_PROD) 
            return titulo.getId();   
    ...
    public void setValueAt(EstoqueConsolacao aValue, int rowIndex, int columnIndex) {   
        EstoqueConsolacao titulo = valores.get(rowIndex);   
    ...
    public EstoqueConsolacao get(int row) {   
